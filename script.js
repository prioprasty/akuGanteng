        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            ...
            if (result.isConfirmed) {
              Swal.fire(`${sender} juga sayang banget sama ${nama} kok xixi`).then(function () {
                Swal.fire({
                  title: 'Seberapa sayang emangnya kak?',
                  icon: 'question',
                  input: 'range',
                    ...
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        Swal.fire(`Huhu iya ${sender} juga kangen ${nama} :((`).then(function () {
                          Swal.fire('Pertanyaan terakhir deh cayang!').then(function () {
